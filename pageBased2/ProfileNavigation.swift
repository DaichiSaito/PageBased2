...
class ProfileNavigation: UINavigationController,UIPageViewControllerDelegate,UIPageViewControllerDataSource,UIScrollViewDelegate {
    ...
    func setupSegmentButtons() {
        ...
        if (buttonText.count == 0) {
            buttonText = ["投稿一覧","詳細プロフィール","third","fourth","etc","etc","etc","etc"] //%%%buttontitle
        }
